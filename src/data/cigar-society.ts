  ...
  sections: [
    {
      ...
      cardText: 'El grupo opera cuatro marcas con identidad, experiencia y público distintos. El reto: mantener esa independencia visual mientras comparten inventario, catálogo de cócteles y operación en un solo backend. Flowbit construirá el ecosistema completo — con una arquitectura que también soportará el POS nativo a partir de noviembre 2026.',
      meta: [
      ...
      blocks: [
        ...
        },
        {
          ...
          listItems: [
            ...
            'Secciones: concepto, menú (enlaza al menú digital), eventos, ubicación, contacto.',
      ...
      cards: [
        {
          ...
          desc: 'Solo Fase 1 — menús, inventario, backend, integración Soft Restaurant.',
          price: '$52,200 MXN',
          label: 'fase 1 c/IVA',
        },
        {
        ...
        {
          title: 'Completo',
          desc: 'Fase 1 + Fase 2 (sitios web × 4 marcas) + paquete foto + carga.',
          price: '$85,840 MXN',
