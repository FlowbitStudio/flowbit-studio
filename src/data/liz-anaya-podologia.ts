...
const lizAnayaPodologia: ProposalData = {
  ...
  sections: [
...

    {
      ...
      tag: 'inversión',
      title: 'Inversión\ndel proyecto',
      description: 'El proyecto completo se paga en 6 mensualidades iguales de $15,000 MXN durante los meses de desarrollo y acompañamiento — sin anticipos escalonados ni pagos por fase. Un flujo mensual fijo que te permite presupuestar sin sorpresas. Al ser un CRM a la medida, no hay licencias mensuales ni cobros por usuario — terminado el plan, el sistema queda siendo tuyo. Comparado con un Odoo/HubSpot del mismo alcance, ahorras entre $3,000 y $8,000 MXN/mes en licencias recurrentes desde el día 1. Incluye hosting y dominio el primer año — a partir del año 2, $3,500 MXN/año corren por cuenta de la clínica.',
      cards: [
        {
          title: 'CRM completo · 6 mensualidades',
          desc: '6 pagos mensuales iguales de $15,000 MXN durante el desarrollo. Control operativo + experiencia clínica + comunicación unificada. Terminado el plan, el CRM queda siendo tuyo — sin licencias recurrentes ni costo por usuario.',
          price: '$15,000 MXN/mes × 6',
          label: 'total $90,000 MXN',
        },
        {
          title: 'Fase 1 · Control operativo y financiero',
          desc: 'Agenda con anticipo, dashboards financieros, bonos, inventario y cortes diarios. Primera fase en arrancar — se desarrolla durante los meses 1–2 del plan.',
          price: '$45,000 MXN',
          label: 'fase 1 · 50% del proyecto',
        },
        {
          title: 'Fase 2 · Experiencia clínica',
          desc: 'Portal del paciente, expediente digital y migración supervisada de +3,000 pacientes. Se desarrolla durante los meses 3–4 del plan.',
          price: '$35,000 MXN',
          label: 'fase 2 · 39% del proyecto',
        },
        {
          title: 'Fase 3 · Unificación de la comunicación',
          desc: 'Bandeja multicanal, bot conversacional, atribución automática y dashboard conversacional. Se desarrolla durante los meses 5–6 del plan.',
          price: '$10,000 MXN',
          label: 'fase 3 · 11% del proyecto',
        },
      ],
    },
